...
\newacronym{awql}{AWQL}{\emph{AdWords Query Language}}
...
\newacronym{mvc}{MVC}{\emph{Model View Controller}}
\newacronym{roi}{ROI}{\emph{Return Over Investiment}}
\newacronym{sp}{SP}{São Paulo}
\newacronym{tdd}{TDD}{\emph{Test Driven Development}}
...
\noindent \textbf{Palavras-chaves:} NoSQL, AdWords API, TDD
